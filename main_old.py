...
#
# def write_account():
#     with open('./data(lesson17)/account.csv', 'w') as open_account:  # Запись изменений в account.csv
...
#     perc = client['percent']
#     term = client['term']
#     e_sum = diff_perc(s_sum, perc, term)
...
# with open('./data(lesson17)/credit.json', 'r') as open_credit:
#     read_credit = open_credit.read()
#     credit_ds = json.loads(read_credit)
# with open('./data(lesson17)/deposit.yaml', 'r') as open_deposit:
#     read_deposit = open_deposit.read()
#     deposit_ds = yaml.load(read_deposit, Loader=yaml.FullLoader)
# with open('./data(lesson17)/account.csv', 'r') as open_account:
